                    ...
                    <div className="lg:col-span-3">
                        ...
                        <ul className="mt-6 space-y-4">
                            {serviceItems.map(item => (
                                <li key={item.title} className="flex flex-col items-start gap-4">
                                    <item.icon className="h-32 w-32 text-blue-600 mt-1 flex-shrink-0" />
                        ...
                        <h3 className="text-2xl mt-6 font-bold text-gray-900">
                            {t('contactTitle')}
                        </h3>
